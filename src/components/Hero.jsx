...
const techPills = [
  ...
  { label: "LangChain", color: "bg-retro-lime" },
  { label: "OpenCV", color: "bg-retro-blue" },
];
      ...
      >
        ...
        <div>
          ...
          >
            ...
            generative-AI systems (LangChain &amp; RAG) that solve real-world
            problems.
          </motion.p>
          <motion.p
            variants={item}
          ...
          <motion.div variants={item} className="flex flex-wrap gap-4 mb-12">
            ...
            <ResumeMenu
              triggerClassName="retro-btn retro-btn--white inline-flex items-center gap-2"
