...
const impactMap = [
  ...
  },
  {
    tech: "LangChain / RAG",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg",
    use: "Generative AI & retrieval pipelines",
    impact: "Context-aware chatbots grounded in company knowledge",
    color: "bg-retro-purple",
  },
  {
    tech: "MERN Stack",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg",
    use: "Full-stack web application development",
    impact: "AI-powered platforms with secure, responsive dashboards",
    color: "bg-retro-pink",
  },
  {
    tech: "MySQL",
