...
const stats = [
  { label: "AI Engineer Intern", value: "Zanzee Co.", color: "bg-retro-yellow" },
  { label: "Coding Challenges", value: "200+", color: "bg-retro-pink" },
...
const highlights = [
  ...
  "Generative AI: LangChain, RAG & FAISS vector search",
  "Computer Vision using OpenCV & TensorFlow",
  "200+ challenges across LeetCode, CodeForces & CodeChef",
];
