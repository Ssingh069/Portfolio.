...
const contactInfo = [
  ...
  },
  {
    icon: FaEnvelope,
    label: "Email",
    value: "saurabhsinghxyz0@gmail.com",
    color: "bg-retro-pink",
  },
  {
    icon: FaMapMarkerAlt,
...
const socialLinks = [
  { Icon: FaLinkedin, href: "https://www.linkedin.com/in/saurabh-singh0000/", label: "LinkedIn" },
  { Icon: FaGithub, href: "https://github.com/Ssingh069", label: "GitHub" },
];
